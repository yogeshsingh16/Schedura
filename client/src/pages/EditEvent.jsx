  ...
  const fetchEvent = async () => {
    try {
      ...
      setForm({
        ...
        location: e.location, isVirtual: e.isVirtual || false,
        meetingLink: e.meetingLink || '',
        maxAttendees: e.maxAttendees || '', tags: e.tags || []
      });
    } catch {
      navigate('/events');
    } finally {
          ...
          <form onSubmit={handleSubmit}>
            <div className="glass-card-static">
              ...
              <div className="create-event-section">
                ...
                <div className="create-event-form-fields">
                  ...
                  <div className="form-group">
                    ...
                    <textarea id="description" name="description" className="form-textarea" value={form.description} onChange={handleChange} required />
                  </div>
                  <div className="form-group">
              ...
              <div className="create-event-section">
                ...
                <div className="create-event-form-fields">
                  <div className="form-group">
                    ...
                    <input id="location" name="location" className="form-input" value={form.location} onChange={handleChange} required />
                  </div>
                  ...
                  {form.isVirtual && (
                    <div className="form-group">
                      ...
                      <input id="meetingLink" name="meetingLink" className="form-input" value={form.meetingLink} onChange={handleChange} />
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="create-event-section">
                ...
                <div className="create-event-form-fields">
                  <div className="form-group">
                    <label className="form-label" htmlFor="maxAttendees">Max Attendees</label>
                    <input id="maxAttendees" name="maxAttendees" type="number" className="form-input" min="1" value={form.maxAttendees} onChange={handleChange} />
                  </div>
                  <div className="form-group">
                    ...
                    <div className="create-event-tags-input">
                      ...
                      <input className="form-input" style={{ flex: 1, minWidth: '120px' }} placeholder="Add a tag..." value={tagInput} onChange={(e) => setTagInput(e.target.value)} onKeyDown={addTag} />
                    </div>
                  </div>
                </div>
              </div>
